...
jQuery("document").ready(function($) {
    ...
    jQuery(".add-new-strip").click(function(){
        ...
        jQuery.post(ajaxurl, data, function (response) {
            ...
            striproottag.parents(".gt3settings_box_content").find(".append_items").append('<li class="strip_block"><div class="sort_drug strip_head">Strip item</div><div class="strip_block_container"><input type="text" value="" name="pagebuilder[strips][' + response + '][striptitle1]" placeholder="Title 1" class="strip_input"><input type="text" value="" name="pagebuilder[strips][' + response + '][striptitle2]" placeholder="Title 2" class="strip_input strip_input2"><input type="text" placeholder="Link" name="pagebuilder[strips][' + response + '][link]" value="" class="strip_input"><input type="text" placeholder="Image" name="pagebuilder[strips][' + response + '][image]" value="" class="gt3UploadImg strip_input"><span class="remove_strip">[x]</span></div></li>');			
