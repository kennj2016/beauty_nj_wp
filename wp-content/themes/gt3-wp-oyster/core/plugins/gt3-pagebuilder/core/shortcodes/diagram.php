...
function diagramm_item($atts, $content = null)
{
    ...
    $compile .= '<li class="skill_li" style="width:'.$diag_width.'%"><div class="skill_wrapper"><div class="skill_item"><div class="chart_wrapper"><div class="chart" data-percent="'.$percent.'">'.$percent.'<span>%</span></div></div><div class="skill_content"><h4>'.$diag_title.'</h4><div class="skill_descr">'.$content.'</div></div></div></div></li>';
