...
jQuery(document).ready(function () {
    ...
    jQuery('.add_image_to_sliders_available_media').click(function(){
        ...
        file_frame.on('select', function () {
            ...
            jQuery.post(ajaxurl, data, function (response) {
                ...
                if (work_with_type == "post_formats") {
                    add_image_to_sliders_available_media_parent.parents('.post-formats-container').find(".selected-images-for-pf").append(response);
                } else {
                    add_image_to_sliders_available_media_parent.parents('.bg_or_slider_option').find(".selected_media .append_block .sortable-img-items").append(response);
                }
