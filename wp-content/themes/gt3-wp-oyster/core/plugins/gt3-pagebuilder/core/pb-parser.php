                ...
                case "price_table":
                    ...
                    if (isset($module["module_items"]) && is_array($module["module_items"])) {
                        ...
                        foreach ($module["module_items"] as $key => $thisitem) {
                            ...
                            $tempcompile .= "[pricetable_item block_name='".$thisitem['block_name']."' block_price='".$thisitem['block_price']."' block_period='".$thisitem['block_period']."' price_features='". esc_attr($price_features)."' block_link='".$thisitem['block_link']."' get_it_now_caption='".$thisitem['get_it_now_caption']."' most_popular='".$thisitem['most_popular']."' width='".$thiswidth."'][/pricetable_item]";
                        }
                    }
